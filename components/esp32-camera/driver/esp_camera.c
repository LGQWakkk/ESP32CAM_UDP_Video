...
esp_err_t esp_camera_init(const camera_config_t *config)
{
    ...
    if (s_state->sensor.id.PID == OV2640_PID) {
        ...
        // s_state->sensor.set_brightness(&s_state->sensor, 5);
        // s_state->sensor.set_gain_ctrl(&s_state->sensor, false);
        // s_state->sensor.set_exposure_ctrl(&s_state->sensor, false);
        // s_state->sensor.set_aec_value(&s_state->sensor, 240);
        // s_state->sensor.set_agc_gain(&s_state->sensor, 10);//0-30
    }
